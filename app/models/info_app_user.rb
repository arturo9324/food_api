class InfoAppUser < ApplicationRecord
 	...
 	validates :fecha_nacimiento, presence: true, :timeliness => { :before => lambda { 18.years.ago }, :type => :date }
	validates_numericality_of :peso, presence: true, :greater_than_or_equal_to => 30, :less_than => 300
